    ...
    >
      <div class="flex flex-wrap gap-1.5">
        <RouterLink
          ...
          :key="n"
          to="/shared"
          class="inline-flex items-center gap-1 rounded-md bg-muted px-2 py-1 font-mono text-2xs text-muted-foreground transition-colors hover:bg-accent hover:text-primary"
          title="跳转到「共享文件」页"
        >
          {{ n }}
