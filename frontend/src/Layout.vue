  ...
  <div class="flex h-full bg-bg text-text">
    <aside
      :class="[
        ...
        'relative flex shrink-0 flex-col border-r border-border bg-surface transition-[width] duration-200 ease-out',
      ]"
      aria-label="主导航"
    >
      ...
      <nav class="flex-1 overflow-y-auto px-3 py-3">
        <div v-if="!collapsed" class="mb-2 px-2 text-[10px] font-semibold uppercase tracking-[0.12em] text-muted/80">
          控制台
        </div>
      ...
      <button
        ...
        class="absolute -right-3 top-20 z-10 flex h-6 w-6 items-center justify-center rounded-full border border-border bg-surface text-muted shadow-soft transition hover:text-text"
      >
    ...
    <div class="flex min-w-0 flex-1 flex-col">
      <header class="sticky top-0 z-20 flex h-16 items-center justify-between gap-4 border-b border-border bg-bg/85 px-6 backdrop-blur-md lg:px-8">
      ...
      <main class="flex-1 overflow-auto">
        <div class="mx-auto w-full max-w-[1480px] px-6 py-6 lg:px-8 lg:py-8">
