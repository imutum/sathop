    ...
    <div class="relative grid w-full max-w-[920px] gap-10 px-6 lg:grid-cols-[1.1fr_1fr]">
      ...
      <div class="hidden flex-col justify-between lg:flex">
        <div class="flex items-center gap-3">
          <div class="grid h-11 w-11 place-items-center rounded-lg border border-border bg-surface text-text shadow-soft">
      ...
      <form
        ...
        class="rounded-lg border border-border bg-surface/95 p-8 shadow-pop backdrop-blur"
      >
        <div class="mb-6">
        ...
        <button
          ...
          class="mt-5 flex w-full items-center justify-center gap-2 rounded-md bg-accent px-3 py-2.5 text-sm font-semibold text-accent-fg shadow-soft transition hover:bg-accent/90 disabled:cursor-not-allowed disabled:opacity-50"
        >
